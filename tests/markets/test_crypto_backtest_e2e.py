"""合并自: test_crypto_e2e.py, test_crypto_portfolio_risk.py
目标: test_crypto_backtest_e2e.py

--- 来源 test_crypto_e2e.py ---
...
--- 来源 test_crypto_portfolio_risk.py ---
...
from tests.markets.test_crypto_mining_lake import FakeCCXTBulk, make_mini_lake

# ==== 来自 test_crypto_e2e.py ====
