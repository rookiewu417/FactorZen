"""组门连坐防呆 + lift manifest 审计保全。

锚定 2026-07-17 方法论事故：150 条候选（130 条 sub-floor 噪声）整组进组门 →
组 lift=-0.0007 全体连坐拒 → 写回 150 条 lift_rejected，并覆写掉此前 top-20
成功的 manifest（n_passed=2 的证据文件丢失）。
"""
