...
def test_construction_defaults():
    """基本构造：默认属性与预期一致。"""
    ctx = MFTDataContext("20260514", "20260514")
...
def test_expanded_start():
    ...
    ctx2 = MFTDataContext("20260105", "20260110")
...
def test_minute_not_declared_raises():
    ...
    ctx = MFTDataContext("20260514", "20260514", required_data=["other"])
...
def test_minute_universe_filter():
    ...
    with patch("intraday.data.context.load_parquet", return_value=synthetic):
        ctx = MFTDataContext("20260514", "20260514", universe=["000001.SZ"])
        lf = ctx.minute
